...
export default function ButtonWithImage({ icon, activeIcon, label, onClickHandler }) {
  ...
  return (
    <div
      className="border-2 border-slate-900 text-slate-900 py-1 px-4 rounded-md flex items-center justify-center gap-2 hover:bg-slate-900 hover:text-white cursor-pointer"
      onMouseEnter={() => {
